...
console.log(nade);
let myAry = studentApp.state.students.filter((std) =>std.firstName.toLowerCase().includes(nade) || std.id.toString().includes(nade) || std.class.toString().includes(nade) || std.DOB.toString().includes(nade))
console.log(myAry);
  ...
  handleStudentForm: (student) => {
    ...
    <h3>${student ? "Update" : "Add"} Student Form</h3>
      ...
      <input class="input" value="${
        ...
        <div>
        gender:
        <input  type="radio" name="gdr" value="Male">Male:
        <input  type="radio" name="gdr" value="Female">Female
        <div><br>
...
//   var radio = document.getElementsByName('gdr');
